...
Every panel uses the Wong colour-blind-safe palette, and the figures
below are regenerated by
\texttt{itrace\ figures\ -\/-out-dir\ output/figures\ -\/-animations};
the legacy \texttt{scripts/generate\_figures.py} also refreshes the
static gallery.
