...
three saccades, two pupil dilation events, one blink, at \SI{120}{\hertz})
...
![Synthetic truth and recovered signals rendered together. The 3-D panel shows the true eyeball orientation, gaze rays, iris, and pupil state at one representative frame; the trace panels repeat the recovered yaw, pitch, and pupil signals with true values, saccades, and the blink interval visible for audit.](../output/figures/eye_orbs_still.png){#fig:orbs width=100%}
